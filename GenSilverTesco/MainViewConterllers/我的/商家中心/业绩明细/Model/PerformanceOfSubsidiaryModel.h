//
//  PerformanceOfSubsidiaryModel.h
//  GenSilverTesco
//
...
@interface PerformanceOfSubsidiaryModel : NSObject
...
@property (nonatomic , copy) NSString              * trl;
@property (nonatomic , copy) NSString              * ywuser;
