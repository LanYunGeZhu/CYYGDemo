...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated {
    ...
    if (highlighted) {
        self.backgroundColor = _style == PopoverViewStyleDefault ? [UIColor colorWithRed:0.23 green:0.23 blue:0.23 alpha:1.00]: [UIColor colorWithRed:0.90 green:0.90 blue:0.90 alpha:1.00] ;
    } else {
